...
class PublicUserAPITests(TestCase):
    ...
    def test_create_valid_user_success(self):
        '''Tetst creating user with valid payload is successful'''
        payload = {
    ...
    def test_user_exits(self):
        ''' Test creating user that laready exists fails'''
    ...
    def test_create_token_for_user(self):
        ''' Test that a toekm is created for the user'''
        payload = {'email': 'test@example.com', 'password': 'pass1234'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        payload = {'email': 'test@example.com', 'password': 'wrongpass1234'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        ...
        self.assertNotIn('token', res.data, res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
